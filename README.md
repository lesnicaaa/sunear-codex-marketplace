...
The user starts each business task in their own Codex session. Project state and review evidence persist in Sunear; private review images remain available independently of the local computer.
...
This verifies marketplace installation, both skills, the Stage MCP definition, and absence of startup hooks, scripts and native receiver artifacts. Authenticated business workflow acceptance remains required.
